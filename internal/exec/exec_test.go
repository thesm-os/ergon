...
// inherited from the parent. The branch gate depends on it — a
// developer with GODEBUG already exported must still get
// gotypesalias=1 for the gobco subprocess.
//
