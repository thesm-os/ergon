...
// link time. The cobra root reads [Full] to populate `ergon
// --version`; the release pipeline (goreleaser) sets the three
// build-time variables via `-X go.thesmos.sh/ergon/internal/version...`.
package version
...
// Full returns the human-facing version string ergon prints for
